...
\title{\Large Ashta-Padi: A Profession-Based Framework for Sanskrit Scriptural Learning \\ (Demo Paper)}
...
The \textit{Ashta-Padi} system architecture leverages a data-driven approach comprising three layers: (1) \textbf{Content Layer} powered by a JSON-based schema that maps Sanskrit texts to morphological markers and professional vocabulary subsets; (2) \textbf{Pedagogy Layer} implementing rule-based logic for profession-specific learning sequences; and (3) \textbf{Interface Layer} providing an interactive, unified web environment for synchronized text and grammar display.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\linewidth]{demo_interface_final.png}
